...
fifa_data %>%
  ...
  theme(axis.title.x = element_text(hjust = 1)) + labs(x= "Overall Rating")
```
...
fifa_data %>%
  ...
  xlab("Age") +
  theme_fivethirtyeight() +
  theme(axis.title = element_text(), axis.title.y = element_blank(), axis.title.x = element_text(hjust = 1))
```
...
fifa_data %>%
  ...
  theme(axis.title.x = element_text(hjust = 1)) + labs(x= "Age")
```
...
holder %>%
  ...
  theme(axis.title.x = element_text(hjust = 1)) + labs(y= "Potential")
...
fifa_data %>%
  ...
  theme_fivethirtyeight() +
  theme(legend.position = "none") +
  theme(axis.title.x = element_text(hjust = 1)) + labs(y= "Overall Rating")
```
...
fifa_data %>%
  ...
  theme_fivethirtyeight() +
  theme(legend.position = "none") +
  theme(axis.title.x = element_text(hjust = 1)) + labs(y= "Elite Players")
