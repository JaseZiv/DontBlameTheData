...
Then I thought, what if I just picked the favourites in the betting market for each game, but with a twist? If the line was less that half a goal (3 points - virtually a coin flip), then I'd just go safe and pick the home team.
...
During the 2019 season, we can see that things would've started off really bleak - after round five, I would've been down over $120! Things started to pick up from there though, even being in the black at round 1. At no point during the 2015 and 2017 seasons would this model have been profitable.
